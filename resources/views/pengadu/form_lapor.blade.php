              ...
              <form class=""  method="post" action="/store" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control @error('isi_laporan') is-invalid @enderror" rows="3" placeholder="" name="isi_laporan" value="{{ old('isi_laporan') }}" required></textarea>
                        @error('isi_laporan')
                  ...
                  <div class="form-group row">
                    <label for="" class="col-sm-3 col-form-label">Lokasi Detail</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="" name="lokasi_kejadian" required value="{{ old('lokasi_kejadian') }}">
                        </div>
                  </div>
                  <div class="form-group row">
