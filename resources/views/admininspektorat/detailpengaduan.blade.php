...
<div class="content-header">
    ...
    @endif  
    @if(Session::has('edittanggapans'))
      <div class="alert alert-success alert-dismissible fade show" role="alert">
          <strong>Tanggapan berhasil diedit</strong>
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
      </div>
    @endif
    @if(Session::has('hapustanggapans'))
      <div class="alert alert-success alert-dismissible fade show" role="alert">
                    ...
                    <div class="card-body">
                        @if(count($tanggapans) > 0)
                                ...
                                <div class="post">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex justify-content-end"><a style="color: black;text-decoration: none;" id="" class="ml-3" href="" data-toggle="modal" data-target="#modal-edit-tanggapan__{{ $tanggapan->id }}" ><i class="fas fa-edit"></i></a>
                                             <!-- Modal Button Detail Pengaduan -->
                                                <div class="modal fade" id="modal-edit-tanggapan__{{ $tanggapan->id }}">
                                                    <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                        <form method="post" action="/edittanggapan/{{ $tanggapan->id }}">
                                                                @csrf
                                                                @method('put')
                                                                <div class="row">
                                                                <div class="col-sm">
                                    ...
                                    <!-- Modal Button Detail Pengaduan -->
                                                    <div class="d-flex justify-content-end"><a style="color: black;text-decoration: none;" id="" class="ml-3" href="" data-toggle="modal" data-target="#modal-hapus-tanggapan__{{ $tanggapan->id }}"><i class="fas fa-trash"></i></a>
                                                </div>
                                                
                                                    <div class="modal fade" id="modal-hapus-tanggapan__{{ $tanggapan->id }}">
                                                        <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <form method="post" action="/hapustanggapan/{{ $tanggapan->id }}">
                                                                @csrf
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-body">
                                ...
                                <dt class="col-sm-5 mt-1">Progress Bar</dt>
